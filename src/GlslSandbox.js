(() => {
    ...
    class GlslSandbox {
        ...
        constructor(canvasSelector, vertexShaderUrl, fragmentShaderUrl, width, height) {
        ...
        compileAndRunShaders(vertexShaderSrc, fragmentShaderSrc) {
            ...
            if (!gl.getShaderParameter(vertexShader, gl.COMPILE_STATUS)) {
                console.log('%Vertex shader error', 'background:#f44; padding:10px; color:#fff; font-weight:bold;')
                console.log(gl.getShaderInfoLog(vertexShader));
                return false
            }

            if (!gl.getShaderParameter(fragmentShader, gl.COMPILE_STATUS)) {
                console.log('%cFragment shader error', 'background:#f44; padding:10px; color:#fff; font-weight:bold;')
